...
| Назначение               | Адрес                                                        | Для чего                                          |
| :----------------------- | :----------------------------------------------------------- | :------------------------------------------------ |
| **Сайт (пользователь)**  | `https://gusarov-dev.duckdns.org:8443`                       | Основной сайт, который видят посетители           |
| **Админка (управление)** | `https://gusarov-dev.duckdns.org:8443/admin`                 | Для добавления проектов и управления контентом    |
| **API (данные)**         | `https://gusarov-dev.duckdns.org:8443/api/projects/`         | Отдает JSON с проектами (используется фронтендом) |
| **Локальная разработка** | `http://localhost:5173` (React) и `http://localhost:8002` (Django) | Только для тестирования на вашем компьютере       |
